...
/**
 * Created by Leonemsolis on 07/11/2017.
 */
...
public class CharTimeHandler {
    ...
    public static final float ATTACK_DASH_TIME = ATTACK_TIME * .65f;
    public static final float ATTACK_RETREAT_TIME = ATTACK_TIME * .35f;
}
